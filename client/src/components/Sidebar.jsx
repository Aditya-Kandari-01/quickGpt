...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  .map((chat) => (
    ...
    >
      <div>
        {/* ✅ FIX: optional chaining + fallback empty string */}
      ...
      {/* User account */}
      <div className="flex items-center justify-between gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer group">
